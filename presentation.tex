...
\begin{frame}[c]
	...
	\large{
		\begin{itemize}
			\item Testované na procesore AMD 3600 s frekvenciou jadra 3.6\,Ghz
		\end{itemize}
	}
	\normalsize{
		\begin{table}[h!]
			\centering
			\include{tables/algs_sum_sk.tex}
		\end{table}
	}
\end{frame}
...
\frame{
	...
	%
	Odporúča sa používať Falcon 1024, rovnakú bezpečnostú úroveň má aj Dilithium 5.
	...
	\begin{table}[h!]
		...
		\begin{tabular}{|l|r|r|r|}
			...
			\hline
			Meno        & Verejný klúč [B] & Súkromný klúč [B] & Podpis [B] \\
			\hline
...
\frame{
	...
	%
	Správa ``Error message'' není zabezpečená proti zneužití.	Môže byť vložená útočníkom do spojenia po získaní TCP seqvenčného čísla. Vložením správy môže útočník ukončiť spojenie predčasne.
}
