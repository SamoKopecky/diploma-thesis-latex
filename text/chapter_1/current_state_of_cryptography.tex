...
% Describe what is the current state of classical cryptography. Mention that the current key lengths for RSA, DSA are not sufficiently big enough to resist quantum computers. Explain the problems that current algorithms use. 