To choose what post-quantum algorithms for key encapsulation and digital signature the program will use, a configuration file is used. It is in a JSON format and 4 keys can be configured
\begin{itemize}
