...
\usepackage{array,ragged2e} % don't now
\usepackage{amsfonts} % don't now
\usepackage{mathtools} % don't now
...
\input{settings}  % do tohoto souboru doplňte údaje o sobě, druhu práce, názvu...
